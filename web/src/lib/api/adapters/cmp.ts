...
//
// O endpoint agrega VIEW_ITENS_VENDA com a MESMA convenção do kpi_marca dos bots
// (venda/custo por CASE em custoReposicaoItem, NOT IN de planos): o CMP filtrado
